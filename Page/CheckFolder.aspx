                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="checkbox warning">
                            <input type="checkbox" id="checkbox-1" name="Clang" value="c" class="Checkbox1">
                            <label for="checkbox-1">C</label>
                        </div>
                    
                        <div class="checkbox primary">
                            <input type="checkbox" id="checkbox-2" name="Cplusplus" value="cpp" class="Checkbox2">
                            <label for="checkbox-2">C++</label>
                        </div>
                    
                        <div class="checkbox success">
                            <input type="checkbox" id="checkbox-3" name="Java" value="java" class="Checkbox3">
                            <label for="checkbox-3">Java</label>
                        </div>
                    
                        <div class="checkbox info">
                            <input type="checkbox" id="checkbox-4" name="CSharp" value="cs" class="Checkbox4">
